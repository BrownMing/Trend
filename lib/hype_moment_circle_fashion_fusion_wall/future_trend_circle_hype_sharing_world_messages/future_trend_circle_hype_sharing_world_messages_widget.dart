...
import 'future_trend_circle_hype_sharing_world_messages_model.dart';
export 'future_trend_circle_hype_sharing_world_messages_model.dart';

class FutureTrendCircleHypeSharingWorldMessagesWidget extends StatefulWidget {
  const FutureTrendCircleHypeSharingWorldMessagesWidget({
    super.key,
    required this.sreetPerformanceCultureCollecChat,
    required this.popCultureVibeInnovationUserid,
  });

  final int? sreetPerformanceCultureCollecChat;
  final int? popCultureVibeInnovationUserid;

  static String routeName = 'FutureTrendCircleHypeSharingWorld_messages';
  static String routePath = '/futureTrendCircleHypeSharingWorldMessages';

  @override
  State<FutureTrendCircleHypeSharingWorldMessagesWidget> createState() =>
      _FutureTrendCircleHypeSharingWorldMessagesWidgetState();
}

class _FutureTrendCircleHypeSharingWorldMessagesWidgetState
    extends State<FutureTrendCircleHypeSharingWorldMessagesWidget> {
  late FutureTrendCircleHypeSharingWorldMessagesModel _model;
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  '${StreetStyleViberaConnection().urbanOutfitTrendSharingUsers.elementAtOrNull(widget.popCultureVibeInnovationUserid!)?.streetTrendEchoSharingUserName}',
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'ntWaveFashionExpressionCollective':
                                      serializeParam(
                                    widget.popCultureVibeInnovationUserid,
                                    ParamType.int,
                                  ),
                                }.withoutNulls,
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: Image.asset(
                                    'assets/images/gdfiuduifoh_djfhiugio.png',
                                  ).image,
                                ),
                              ),
                            ),
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: Image.asset(
                                    'assets/images/vbuyifsaiuodfasd_weirusydghasidfgadso.png',
                                  ).image,
                                ),
                              ),
                            ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final globalTrendLifestyleSharingComm =
                                  StreetStyleViberaConnection()
                                      .aestheticStyleInspirationMessages
                                      .where((e) =>
                                          widget
                                              .sreetPerformanceCultureCollecChat ==
                                          e.globalHypeFashionExchangeMessageChatref)
                                      .toList();
                              ...
                              return ListView.builder(
                                ...
                                itemCount:
                                    globalTrendLifestyleSharingComm.length,
                                itemBuilder: (context,
                                    globalTrendLifestyleSharingCommIndex) {
                                  final globalTrendLifestyleSharingCommItem =
                                      globalTrendLifestyleSharingComm[
                                          globalTrendLifestyleSharingCommIndex];
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.fill,
                                    image: Image.asset(
                                      'assets/images/dafsgasdgfoiadsfugo_dfiuguyadsofguid.png',
                                    ).image,
                                  ),
                                ),
                                child: Stack(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: Image.asset(
                                      'assets/images/xcvsydugfiuyas_asdgfyuasdgfioadfg.png',
                                    ).image,
                                  ),
                                ),
                              ),
