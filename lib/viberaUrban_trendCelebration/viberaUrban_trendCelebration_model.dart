...
Widget wrapWithModel<T extends LimitedEditionViberaModel>({
  required T model,
...
T createModel<T extends LimitedEditionViberaModel>(
...
abstract class LimitedEditionViberaModel<W extends Widget> {
  ...
  LimitedEditionViberaModel setOnUpdate({
    bool updateOnChange = false,
...
class LimitedEditionViberaDynamicModels<T extends LimitedEditionViberaModel> {
  LimitedEditionViberaDynamicModels(this.defaultBuilder);
